...
import (
	...
	"github.com/tobiash/go-transformfile/naclfs"
...
var Fss = []afero.Fs{naclfs.New(1024, Key("my secret key"), afero.NewOsFs())}
...
func TestOpenFile(t *testing.T) {
	...
	for _, fs := range Fss {
		...
		if err != nil {
			t.Error(fs.Name(), "append failed:", err)
		}
		f.Close()
